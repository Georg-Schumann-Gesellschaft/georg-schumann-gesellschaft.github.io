...
![CD Cover]({{ site.url }}{{ site.baseurl }}/assets/images/2020-CD_Klavierwerke.jpg){: .align-left}

**Interpret:** [Michael van Krücker](https://michaelvankruecker.de) (Klavier)

- Sechs Fantasien op. 36 (1904)
- Stimmungsbilder op. 2 (1886)
- Drei Stücke op. 1 (1886)
- Drei Stücke op. 23 (1901)

Die erste CD, die sich ausschließlich Schumanns Klavierschaffen widmet, erschienen am 20. August 2020.

</div>

<div class="archive__item" markdown="1" style="overflow: hidden; border-bottom: 1px solid #f2f3f3;">

### Georg Schumann - Lieder (2018)

![CD Cover]({{ site.url }}{{ site.baseurl }}/assets/images/cd-ford-lieder.jpg){: .align-left}
...
Label: Stone, Erscheinungstermin: 26. Januar 2018.

</div>

<div class="archive__item" markdown="1" style="overflow: hidden; border-bottom: 1px solid #f2f3f3;">

### Georg Schumann - Symphonie op. 42 (2017)

![CD Cover]({{ site.url }}{{ site.baseurl }}/assets/images/cover_synph-42.jpg){: .align-left}

**Interpreten:** [Deutsches Symphonie-Orchester Berlin](https://www.dso-berlin.de), [James Feddeck](https://jamesfeddeck.com)
...
- Klavierquartett in f-moll op. 29 (1901)
- Sonate für Klavier und Violoncello e-Moll op. 19

**Interpreten:** Münchner Klaviertrio, Michael Arlt (Violine), Gerhard Zank (Violoncello), Donald Sulzen (Piano), Dietrich Cramer (Viola). Label: CPO, 2015.

</div>

<div class="archive__item" markdown="1" style="overflow: hidden; border-bottom: 1px solid #f2f3f3;">

### Georg Schumann - Lieder (2006)

![CD Cover]({{ site.url }}{{ site.baseurl }}/assets/images/cd-lieder.jpg){: .align-left}

**Interpreten:** Silvia Weiss (Sopran), Karola Theill (Klavier)

6 Lieder op. 56, 3 Lieder op. 15, Mädchenlieder op. 35, etc. Label: CPO, 2006.

</div>

<div class="archive__item" markdown="1" style="overflow: hidden; border-bottom: 1px solid #f2f3f3;">

### Georg Schumann - Symphonie h-moll "Preis-Symphonie" (2012)

![CD Cover]({{ site.url }}{{ site.baseurl }}/assets/images/cd-h-moll.jpg){: .align-left}

**Interpreten:** Münchner Rundfunkorchester, Leitung: Christoph Gedschold. Label: CPO, 2012.

</div>

<div class="archive__item" markdown="1" style="overflow: hidden; border-bottom: 1px solid #f2f3f3;">

### Georg Schumann - Klaviertrios Nr. 1 und 2 (2011)

![CD Cover]({{ site.url }}{{ site.baseurl }}/assets/images/cd-pianotrios.jpg){: .align-left}

**Interpreten:** Münchner Klaviertrio. Label: CPO, 2011.
...
![CD Cover]({{ site.url }}{{ site.baseurl }}/assets/images/cd-jerusalem.jpg){: .align-left}

**Interpreten:** The Purcell Singers, Mark Ford. Label: Guild, 2007.
...
![CD Cover]({{ site.url }}{{ site.baseurl }}/assets/images/cd-violinsonaten.jpg){: .align-left}

**Interpreten:** Volker Burkhart, Christoph Weinhart. Label: JUBALmusic.

</div>

<div class="archive__item" markdown="1" style="overflow: hidden; border-bottom: 1px solid #f2f3f3;">

### Georg Schumann - Chorwerke (2001)

![CD Cover]({{ site.url }}{{ site.baseurl }}/assets/images/cd-chorwerke.jpg){: .align-left}

**Interpreten:** The Purcell Singers, Mark Ford. Label: ASV, 2001.

</div>

<div class="archive__item" markdown="1" style="overflow: hidden; margin-bottom: 3em;">

### Georg Schumann - Geistliche Musik der Spätromantik

![CD Cover]({{ site.url }}{{ site.baseurl }}/assets/images/cd-geistl.musik.jpg){: .align-left}

**Interpreten:** Jörg Strodthoff, Sing-Akademie zu Berlin, Alsfelder Vokalensemble. Label: JUBALmusic.
